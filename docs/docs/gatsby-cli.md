...
আপনি `package.json` এর স্ক্রিপ্ট দিয়ে এই কমান্ডগুলি ব্যবহার করতে পারেন, সাধারণত বেশিরভাগ [স্টার্টার্সে](/docs/starters/)  _আপনার জন্য_ প্রকাশ করা হয়েছে । উদাহরণস্বরূপ, আপনি যদি নিজের অ্যাপ্লিকেশনে [`gatsby develop`](#develop) কমান্ডটি ব্যবহার করতে চান তবে `package.json` খুলুন এবং এই রকম স্ক্রিপ্ট যুক্ত করুন ঃ
...
- ডিফল্ট স্টার্টার ব্যবহার করে `my-awesome-site` নামের একটি Gatsby সাইট বানান ঃ

```shell
gatsby new my-awesome-site
```

- [gatsby-starter-blog](https://www.gatsbyjs.org/starters/gatsbyjs/gatsby-starter-blog/) ব্যবহার করে `my-awesome-blog-site` নামে একটি Gatsby সাইট তৈরি করুন ঃ

```shell
gatsby new my-awesome-blog-site https://github.com/gatsbyjs/gatsby-starter-blog
```

- যদি আপনি দুটো আর্গুমেন্ট-ই উল্লেখ না করেন, CLI এই ইনপুটগুলির জন্য জিজ্ঞাসা করে একটি ইন্টারেক্টিভ শেল চালাবে ঃ ঃ
...
আপনি Gatsby সাইট ইনস্টল করার পরে, আপনার প্রজেক্টের রুট ডিরেক্টরিতে যান এবং ডেভেলপমেন্ট সার্ভারটি চালু করুন ঃ
...
আপনি একই নেটওয়ার্কের অন্যান্য ডিভাইসে আপনার ডেভেলপমেন্ট ইনভায়রনমেন্টটি অ্যাক্সেস করতে হোস্ট অপশনের সাহায্যে Gatsby ডেভেলপ কমান্ড ব্যবহার করতে পারেন, চালান ঃ
...
Gatsby সাইটের রুটে আপনার অ্যাপ্লিকেশনটি কম্পাইল করুন এবং ডেপ্লয়মেন্টের জন্য প্রস্তুত করুন ঃ
...
Gatsby সাইটের রুটে, পরীক্ষণের জন্য আপনার সাইটের প্রোডাকশন বিল্ড পরিবেশন করুন ঃ
...
Gatsby সাইটের রুটে, ইনভায়রনমেন্ট সম্পর্কিত কার্যকর তথ্য পান যা বাগ রিপোর্ট করার সময় প্রয়োজনীয় হবে ঃ
...
Gatsby সাইটের রুটে, cache (`.cache` ফোল্ডার) এবং পাবলিক ডিরেক্টরিগুলি রিমুভ করুন ঃ

`gatsby clean`

এটি যখন আপনার লোকাল প্রজেক্টে সমস্যা দেখা দেয় বা কনটেন্ট রিফ্রেশ হচ্ছে না বলে মনে হয় তখন এটি সর্বশেষ অবলম্বন হিসাবে কার্যকর। সাধারণত এই সমস্যাগুলি এটি সমাধান করতে পারে ঃ
...
আপনার Gatsby ইনভায়রনমেন্ট সহ একটি Node.js REPL (ইন্টারেক্টিভ শেল) পান ঃ

`gatsby repl`

Gatsby আপনাকে কমান্ড টাইপ করতে এবং এক্সপ্লোর করতে অনুরোধ করবে। যখন এটি দেখায় ঃ `gatsby >`

আপনি একটি কমান্ড টাইপ করতে পারেন, যেমন এইগুলির মধ্যে একটি ঃ
...
এই ফাইলটি আপনার সিস্টেমে এখানে পাওয়া যাবে ঃ `~/.config/gatsby/config.json`
